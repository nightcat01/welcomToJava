...
ALTER TABLE jforum_sessions MODIFY session_id VARCHAR2(150);
ALTER TABLE jforum_search_results MODIFY session_id VARCHAR2(150);
ALTER TABLE jforum_search_topics MODIFY session_id VARCHAR2(150);
